const cfConfig = {
    cssBase:
      ...
      "https://cdn.jsdelivr.net/gh/AnamayKashiv/contact-form@upload-form",
    error: {
      title: "Error",
      message:
        getElemById("contactform").getAttribute("error_text") ||
        "Sorry, an error occurred while uploading! , Try contacting me.",
    },
    success: {
      title: "Uploaded",
      message:
        getElemById("contactform").getAttribute("success_text") ||
        "Your file is uploaded and will be added here soon after checking.",
    },
  },
  cfbody =
  ...
  cfform =
    '\n<h3 class="title">Upload</h3>\n<p>Upload your file</p>\n<div>\n\t<input class="element" onchange="cfonChange(\'cffile\')" id="cffile" type="file" name="file" placeholder="Upload File" autocomplete="off">\n\t<button id="cfbutton" onclick="cfSubmitMessage()" class="form-button color">Send your message</button><a href="https://telegram.me/AnamayKashiv" class="cfpromo">Contact via Telegram</a>\n</div>\n';
function cfClick() {
...
async function cfSubmitMessage() {
  var cfvalue = {
    ...
    phone_no: getElemById("cffile").value,
